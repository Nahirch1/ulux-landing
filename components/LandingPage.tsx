...
const COMPANY = {
  ...
  instagramUrl:
    'https://www.instagram.com/_u_lux?igsh=emozYXY0bDZ6MjBo',
...
const services = [
  {
    ...
    text: 'Instalaciones para viviendas, comercios y obras.',
    icon: Zap
  },
  {
    title: 'Tableros y protecciones',
    text: 'Armado y actualización de tableros eléctricos.',
    icon: CircuitBoard
  },
  {
    title: 'Iluminación técnica',
    text: 'Iluminación interior, exterior y decorativa.',
    icon: Lightbulb
  },
  {
    title: 'Automatización',
    text: 'Control de iluminación y sistemas eléctricos.',
    icon: Settings2
  },
  {
    title: 'Obras y ampliaciones',
    text: 'Ejecución y ampliación de instalaciones.',
    icon: Building2
  },
  {
    title: 'Mantenimiento',
    text: 'Diagnóstico, reparación y mantenimiento eléctrico.',
    icon: Wrench
  }
];
...
const projects = [
  {
    ...
    description: 'Iluminación exterior integrada a la fachada.'
  },
  {
    src: '/images/interior-iluminacion.jpg',
    title: 'Iluminación interior indirecta',
    category: 'Terminación',
    description: 'Iluminación perimetral integrada al ambiente.'
  },
  {
  ...
  },
  {
    ...
    category: 'Ejecución',
    description: 'Tendido eléctrico durante la etapa de obra.'
  },
  {
    src: '/images/canalizacion-muro.jpg',
    title: 'Distribución por muro',
    category: 'Instalación',
    description: 'Cañerías y cajas preparadas para terminación.'
  },
  {
    src: '/images/estructura-canalizacion.jpg',
    title: 'Canalización sobre estructura',
    category: 'Obra nueva',
    description: 'Recorridos eléctricos integrados a la estructura.'
  }
];
...
export function LandingPage() {
  ...
  useEffect(() => {
    document.body.style.overflow =
      menuOpen || selectedProject !== null ? 'hidden' : '';
  ...
  const whatsappHref = (
    message = 'Hola U-LUX, quisiera solicitar un presupuesto.'
  ) =>
  ...
  const submitForm = (event: FormEvent<HTMLFormElement>) => {
    ...
    setFormStatus('Abrimos WhatsApp con tu solicitud.');
  };
  ...
  return (
    <main className="overflow-hidden bg-ink text-white">
      ...
      <header className="fixed inset-x-0 top-0 z-50 border-b border-white/10 bg-ink/70 backdrop-blur-xl">
        <div className="mx-auto flex h-20 max-w-7xl items-center justify-between px-5 lg:px-8">
          ...
          <nav className="hidden items-center gap-8 text-sm text-white/70 lg:flex">
            {['Servicios', 'Trabajos', 'Presupuesto', 'Contacto'].map(
              (item) => (
                <a
                  key={item}
      ...
      <AnimatePresence>
        {menuOpen && (
          <motion.div
            className="fixed inset-0 z-[60] bg-ink px-6 py-5"
          ...
          >
            <div className="flex items-center justify-between">
              <span className="text-xl tracking-[0.18em]">
                U-LUX
              </span>
            ...
            <nav className="mt-20 flex flex-col gap-6 text-4xl font-light">
              {[
                ...
                >
                  <span className="mr-4 text-sm text-gold">
                    0{index + 1}
                  </span>
                  {item}
                </motion.a>
      ...
      <section
        id="inicio"
        className="relative flex min-h-screen items-end pt-20"
      >
        <motion.div
        ...
        >
          <Image
            ...
            alt="Obra residencial con iluminación exterior realizada por U-LUX"
            fill
            priority
        ...
        <div className="relative z-10 mx-auto w-full max-w-7xl px-5 pb-20 lg:px-8 lg:pb-28">
          ...
          >
            <motion.div
              variants={fadeUp}
              className="mb-6 flex items-center gap-3 text-xs uppercase tracking-[0.28em] text-gold-soft"
            >
              <span className="h-px w-10 bg-gold" />
              Instalaciones · Obras · Automatización
            </motion.div>

            <motion.h1
              variants={fadeUp}
              className="max-w-4xl text-5xl font-medium leading-[0.98] tracking-[-0.045em] sm:text-6xl lg:text-[86px]"
            >
            ...
            <motion.p
              variants={fadeUp}
              className="mt-7 max-w-xl text-base leading-7 text-white/68 sm:text-lg"
            >
              Soluciones eléctricas para viviendas,
              comercios y obras.
            </motion.p>
      ...
      <section className="border-y border-white/10 bg-carbon">
        <div className="mx-auto grid max-w-7xl grid-cols-2 divide-x divide-y divide-white/10 px-5 lg:grid-cols-4 lg:divide-y-0 lg:px-8">
          {[
            ...
            <div
              key={label as string}
              className="flex items-center gap-3 px-4 py-6 text-sm text-white/65 lg:px-7"
            >
      ...
      <section
        id="servicios"
        className="border-y border-white/10 bg-carbon py-24 lg:py-32"
      >
        <div className="section-shell">
          <Reveal>
            ...
            <div className="flex flex-col justify-between gap-6 lg:flex-row lg:items-end">
              ...
              <p className="max-w-md text-white/52">
          ...
          <Reveal delay={0.15}>
            <div className="mt-10 flex justify-center">
              <a
                href={whatsappHref(
                  'Hola U-LUX, quisiera consultar por un servicio eléctrico.'
                )}
                target="_blank"
                rel="noreferrer"
            ...
            {projects.map((project, index) => (
              ...
              >
                ...
                <div className="absolute inset-x-0 bottom-0 flex items-end justify-between p-6 text-left">
                  <div>
                    <span className="text-xs uppercase tracking-[0.18em] text-gold-soft">
                      {project.category}
                    </span>
                  ...
                  <div className="rounded-full border border-white/25 bg-black/25 p-3 backdrop-blur transition duration-300 group-hover:scale-110 group-hover:border-gold group-hover:bg-gold group-hover:text-black">
                    <ArrowDownRight size={18} />
                  </div>
                </div>
              </motion.button>
      ...
      <AnimatePresence>
        {selectedProject !== null && (
          <motion.div
            className="fixed inset-0 z-[70] flex items-center justify-center bg-black/92 p-4 backdrop-blur-md"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
          ...
          >
            <motion.div
              className="relative w-full max-w-5xl overflow-hidden rounded-[28px] border border-white/10 bg-carbon"
            ...
            >
              ...
              <button
                className="absolute right-4 top-4 rounded-full bg-black/65 p-3 backdrop-blur"
                onClick={() => setSelectedProject(null)}
                aria-label="Cerrar"
              >
                <X />
        ...
        <div className="section-shell grid gap-16 lg:grid-cols-[0.8fr_1.2fr]">
          <Reveal>
            ...
            <p className="mt-6 max-w-md leading-7 text-white/55">
              Contanos qué necesitás o escribinos directamente.
            </p>
          ...
          <Reveal delay={0.1}>
            <form
              onSubmit={submitForm}
              className="rounded-[28px] border border-white/10 bg-panel p-6 sm:p-8"
            >
              <div className="grid gap-5 sm:grid-cols-2">
                ...
                <label className="field-label">
                  ...
                  <select
                    ...
                    defaultValue="Instalaciones eléctricas"
                  >
      ...
      <footer className="border-t border-white/10 bg-ink py-10">
        <div className="section-shell flex flex-col gap-8 text-sm text-white/45 md:flex-row md:items-center md:justify-between">
          <div>
            ...
            <span className="ml-3">
              Instalaciones diseñadas para durar.
            </span>
          </div>
